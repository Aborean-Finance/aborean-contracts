...
contract VeArtProxy is IVeArtProxy {
    ...
    string[5][10] palettes = [
        ['#D3D3D3', '#B0B0B0', '#8C8C8C', '#6B6B6B', '#4A4A4A'], // grey
        ['#1A1A1A', '#141414', '#0F0F0F', '#0A0A0A', '#000000'], // black
        ['#D8F3DC', '#A3D9A5', '#6FCF75', '#4CAF50', '#2E7D32'], // light green
        ['#A67B5B', '#8B5E3C', '#704327', '#56301B', '#3C1E10'], // brown
        ['#FFFDD0', '#F6F0BA', '#EDE3A4', '#E4D68F', '#DCC97A'], // cream
        ['#FF6F61', '#6B5B95', '#88B04B', '#F7CAC9', '#92A8D1'], // random
        ['#FF66CC', '#E055B5', '#C44DA0', '#A9468B', '#8F3F77'], // magenta
        ['#2E8B57', '#276D48', '#20503A', '#19342B', '#13281F'], // dark green
        ['#FFDDE1', '#FFC2CC', '#FFA7B8', '#FF8CA3', '#FF708E'], // light pink
        ['#F5F5DC', '#EDE5C8', '#E5DDB4', '#DDD5A0', '#D5CD8C']  // beige
    ];
                ...
                string(
                    abi.encodePacked(
                        '{',
                            ...
                            '"description": "Aborean is a next-generation AMM that combines the best of Curve, Convex and Uniswap, designed to serve as the Abstract central liquidity hub. Aborean NFTs vote on token emissions and receive bribes and fees generated by the protocol.",',
    ...
    /// @dev Calculates the number of digits before the "decimal point" in an NFT's veABX balance.
    ///      Input expressed in 1e18 format.
    function numBalanceDigits (uint256 _balanceOf) internal pure returns (int256 digitCount) {
        uint256 convertedveABXvalue = _balanceOf / 1e18;
        while (convertedveABXvalue != 0) {
            convertedveABXvalue /= 10;
            digitCount++;
        }
    }
    ...
    /// @dev Determines the number of lines in the SVG. NFTs with less than 10 veABX balance have zero lines.
