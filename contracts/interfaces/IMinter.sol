...
interface IMinter {
    ...
    /// @notice Starting weekly emission of 10M ABX (ABX has 18 decimals)
    ...
    ///         weekly * ((abx.totalsupply - ve.totalSupply) / abx.totalsupply) ^ 2 / 2
    ///         Note that ve.totalSupply is the locked ve supply
    ///         abx.totalSupply is the total ve supply minted
    /// @param _minted Amount of ABX minted this epoch
